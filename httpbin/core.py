...
app.config["SWAGGER"] = {"title": "httpbin.cn", "uiversion": 3}
...
template = {
    ...
    "info": {
        "title": "httpbin.cn",
        "description": (
            "<br/> <br/> <code>A simple HTTP Request & Response Service.</code>"
        ),
        "contact": {
            "responsibleOrganization": "Xizhen Du",
            "responsibleDeveloper": "Xizhen Du",
            "email": "me@httpbin.cn",
            "url": "https://httpbin.cn",
        },
